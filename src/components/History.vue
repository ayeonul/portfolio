        ...
        <div class="career-list">
          <ul>
            ...
            <li>
              참여 프로젝트
              <ul>
                <li>부산광역시 통합홈페이지 AI 부기뉴스 개발(2025.07~2025.10)</li>
                <ul>
                  <li>참여인원 2인(AI 엔진 개발 기준), 참여도 90%</li>
                  <li>
                    사용자의 입력에 기반해 부산시보, 보도자료, 정책 및 행사 등의 정보를 안내해주는 RAG 챗봇 서비스 개발
                  </li>
                    <ul>
                      <li>문서 임베딩을 이용한 자연어 검색 엔진 (sementic search) 개발</li>
                      <li>안내를 위한 생성형 언어모델 프롬프팅</li>
                      <li>안내 문서 정제 및 라벨링</li>
                    </ul>
      ...
      <div class="career-container">
        ...
        <div class="career-list">
          <ul>
            ...
            <li>
              Transformers 계열의 자연어 처리(NLP) 기술 연구 및 응용 서비스 개발
            </li>
            <li>FastAPI를 이용한 AI 응용 서비스의 API 개발</li>
            <li>웹 크롤링 및 각종 API 서비스를 이용한 데이터 수집 및 정제</li>
            <li>AI 엔진 데모 버전의 웹사이트 개발</li>
            <li>
              참여 프로젝트
              <ul>
                <li>인천사이버진로교육원 진로 추천 AI 개발(2022.03~2023.11)</li>
                <ul>
